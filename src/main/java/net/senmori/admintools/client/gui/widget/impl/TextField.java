...
import net.senmori.admintools.client.gui.widget.AbstractLabel;
import net.senmori.admintools.client.gui.widget.AbstractTextFieldWidget;
 ...
 * stated (i.e. setting {@link #setDefaultSuggestionText(String)} to null and replacing the default}.
 *
...
@OnlyIn( Dist.CLIENT )
public class TextField extends AbstractTextFieldWidget {
    ...
    public void setTextFormatter(BiFunction<String, Integer, String> formatter) {
        this.textFormatter.set(new TextFormatter("text formatter", formatter));
    }
    ...
    public void setSuggestionTextFormatter(BiFunction<String, Integer, String> formatter) {
        this.suggestionTextFormat.set( new TextFormatter("suggestion text formatter", formatter) );
    }
     ...
     * use {@link #setDefaultSuggestionText(String)}.
     * <br>
     * This is the method that will be used the most, as {@link #setDefaultSuggestionText(String)} should only
     * be used once to set the default suggestion text.
     *
     * @param text the new text.
     *
     * @see #setDefaultSuggestionText(String)
     */
    @Override
     ...
     */
    @Override
    public void setDefaultSuggestionText(@Nullable String text) {
        super.setSuggestionText( text );
    }
    ...
    public void setTextBoxBorderColor(Color color) {
        this.textBoxBorderColor.set( color );
    }
    ...
    public void setTextBoxBGColor(Color color) {
        this.textBoxForegroundColor.set( color );
    }
    ...
    public boolean shouldRemoveSuggestionOnFocus() {
        return super.shouldRemoveSuggestionOnFocus();
    }

    @Override
    public boolean shouldRestoreSuggestionOnFocus() {
        return super.shouldRestoreSuggestionOnFocus();
    }
